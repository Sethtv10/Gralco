...
<div id="contenido">
		<p>Editar póliza daños</p>
			<form id="formRegistro" action="<?php  echo 'danios.php?'.$_SERVER['QUERY_STRING']; ?>" method="post">
			...
			<table cellpadding="0" cellspacing="0" border="1" align="center" width="393">
                ...
                <tr>
                    ...
                    <td><input type="text" size="30" name="sec1contenido" id="sec1contenido" autocomplete="off" value="<?php  echo $contenidosh; ?>" /></td>
                </tr>
                <tr>
