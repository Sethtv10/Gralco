...
if(isset($_POST['idpol']))
{
	...
	{
		echo "entro a formapago > formapagoorg \n";
	...
	//Editar la poliza y la tabla autos
			...
			$sqlnvo = "UPDATE vida SET ";
			$sqlnvo.= "plan='".$_POST['plan']."',";
			$sqlnvo.= "contratante='".$_POST['contratante']."',";
			$sqlnvo.= "asegurado='".$_POST['asegurado']."',";
			$sqlnvo.= "aseguradoman='".$_POST['aseguradoman']."',";
			$sqlnvo.= "aseguradomenor='".$_POST['aseguradomenor']."'";
			$sqlnvo.= " WHERE idpol='".$_POST['idpol']."'";
			$resnvo = mysql_query($sqlnvo) or die (mysql_error());
			$mensaje="Se guardaron los cambios.";
			$camposbit="usuario,accion,poliza,fecha,hora";
			$valorbit = "'".$_SESSION['usera']."','Edito poliza vida','".$_POST['poliza']."/".$_POST['idpol']."','".date("j")."/".date("n")."/".date("Y")."','".date("g:i a")."'";
...
<div id="contenido">
		<p>Editar póliza vida</p>
			<form id="formRegistro" action="vida.php<?php  echo "?".$_SERVER['QUERY_STRING']; ?>" method="post">
			...
			<table cellpadding="0" cellspacing="0" border="1" align="center" width="387">
                ...
                <tr>
                    ...
                    <td><input type="text" size="30" name="contratante" id="contratante" autocomplete="off" value="<?php  echo $contratanteh; ?>" /></td>
                </tr>
                <tr>
                    <td><div id="etiqueta">
                      <label>Asegurado:</label></div></td>
                    <td><input type="text" size="30" id="asegurado" name="asegurado" autocomplete="off" value="<?php  echo $aseguradoh; ?>" /></td>
                </tr>
                <tr>
                    <td><div id="etiqueta">
                      <label>Asegurado mancomunado:</label></div></td>
                    <td><input type="text" size="30" id="aseguradoman" name="aseguradoman" autocomplete="off" value="<?php  echo $asegumanh; ?>" /></td>
                </tr>
                <tr>
                    <td><div id="etiqueta">
                      <label>Asegurado menor:</label></div></td>
                    <td><input type="text" size="30" id="aseguradomenor" name="aseguradomenor" autocomplete="off" value="<?php  echo $asegumenh; ?>"/></td>
                </tr>
				 <tr align="center">
        		...
        		<tr align="center">
                    <td colspan="5" align="center"><div id="btn">
                      <input type="submit" name="submit" value="Editar póliza" />
						<input type="hidden" name="tipopol" value="vida" />
