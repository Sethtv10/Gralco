   ...
   <table width='900' cellpadding='0' cellspacing='0' border='0' align='center'>
        <tr>
            <td height="40" align="center"><div id="etiqueta">
              <label>Historial cliente: <?php  echo $_GET['nombre']; ?></label></div></td>
        </tr>
    </table>
    <table width='900' cellpadding='0' cellspacing='0' border='0' align='center'>
            <tr>
					...
					<td width="477">
						<table width="477" align="left" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td><input type="text" name="txtNombre" id="txtNombre" autocomplete="off" size="55" value="<?php  echo $nombre; ?>" /></td>
								</tr>
								<tr valign="top">
									<td><div id="etiqueta">
									  <label>Domicilio:</label></div></td>
									<td><textarea name="domicilio" id="domicilio"><?php  echo $direccion; ?></textarea></td>
								</tr>
								<tr>
									<td><div id="etiqueta">
									  <label>Colonia:</label></div></td>
								  <td><input type="text" name="colonia" id="colonia" autocomplete="off" size="55" value="<?php  echo $colonia; ?>" /></td>
								</tr>
								<tr>
									<td><div id="etiqueta">
								  ...
								  <td>
									<table width="370" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td width="59">
				<input type="text" name="cp" id="cp" autocomplete="off" size="5" maxlength="5" value="<?php  echo $cp; ?>" /></td>
											<td width="100" align="left"><div id="etiqueta">
									  <label>RFC:</label></div></td>
											<td width="211"><input type="text" name="rfc" id="rfc" autocomplete="off" size="22" value="<?php  echo $rfc; ?>" /></td>
										</tr>
									</table>
								  </td>
								</tr>
								<tr>
								  ...
								  <td>
									<table width="370" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td width="75">
				<input type="text" name="ciudad" id="ciudad" autocomplete="off" size="15" value="<?php  echo $ciudad; ?>" /></td>
											<td width="100" align="left"><div id="etiqueta">
									  <label>Estado:</label></div></td>
											<td width="195"><input type="text" name="estado" id="estado" autocomplete="off" size="12" value="<?php  echo $estado; ?>" /></td>
										</tr>
									</table>
								  </td>
								</tr>
					...
					<td width="473">
						<table width="473" align="left" border="0" cellspacing="0" cellpadding="0">
								<tr valign="top">
									...
									<td width="372"><input type="text" size="20" name="numcliente" autocomplete="off" value="<?php  echo $numcliente; ?>" /></td>
								</tr>
								<tr>
									<td><div id="etiqueta">
									...
									<?php  for ($a=1;$a<=31;$a++)
										{
									?>
											<option value="<?php  echo $a; ?>" <?php  if ($dia==$a){ ?> selected="selected" <?php  } ?>><?php  echo $a; ?></option>
									<?php 
										}
									?>
									</select>
									...
									<?php  for ($a=1;$a<=12;$a++)
										{
									?>
											<option value="<?php  echo $a; ?>" <?php  if ($mes==$a){ ?> selected="selected" <?php  } ?>><?php  echo $a; ?></option>
									<?php 
										}
									?>
									</select>&nbsp;<input type="text" size="4" id="anio" name="anio" maxlength="4" value="<?php  echo $anio; ?>" /></td>
								</tr>
								<tr>
                                	<td colspan="2">&nbsp;</td>
                                </tr>
								<tr valign="top">
									...
									<td width="372"><input type="text" size="20" name="tel" autocomplete="off" value="<?php  echo $tel; ?>" /></td>
								</tr>
								<tr valign="top">
									<td width="101"><div id="etiqueta">Telefono móvil:</div></td>
									<td width="372"><input type="text" size="20" name="telcel" autocomplete="off" value="<?php  echo $telmov; ?>" /></td>
								</tr>
								<tr valign="top">
								...
								<tr valign="top">
									...
									<td width="372"><select name="tipoclie" size="1">
													<option value="particular" <?php  if ($tipoclie=="particular"){ ?> selected="selected" <?php  } ?>>Particular</option>
													<option value="empresa" <?php  if ($tipoclie=="empresa"){ ?> selected="selected" <?php  } ?>>Empresa</option>
													</select>
									</td>
								</tr>
						</table>
...
<?php 			}
	...
	if(mysql_num_rows($resp)>0)
	{
		...
		?>
		<table width='900' cellpadding='0' cellspacing='0' border='0' align='center'>
        	<tr <?php  if ($contador%2!=0) { echo 'bgcolor="#333333"'; } ?> height="20">
          		<td width="139"><a href="<?php  echo $enlace; ?>" class="blanco"><?php  echo $numpoliza; ?></a></td>
                <td width="112"><div id='etiqueta'><?php  echo $status; ?></div></td>
                <td width="127"><div id='etiqueta'><?php  echo $tipopoliza; ?></div></td>
                <td width="130"><div id='etiqueta'><?php  echo $compania; ?></div></td>
                <td width="392"><div id='etiqueta'><?php  echo $detalle; ?></div></td>
            </tr>
        </table>
	<?php 	$contador++;
		} ?>
