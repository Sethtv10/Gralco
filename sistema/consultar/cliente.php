...
<div id="contenido">
		<p>Editar cliente</p>
			<form id="formRegistro" action="<?php  echo $_SERVER['PHP_SELF'].'?'.$_SERVER['QUERY_STRING'];?>" method="post">
								...
								<tr>
								  ...
								  <td>
									<table width="370" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td width="59">
				<input type="text" name="colonia" id="colonia" autocomplete="off" size="5" maxlength="5" value="<?php  echo $colonia; ?>" /></td>
