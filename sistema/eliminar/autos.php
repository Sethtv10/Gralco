...
$permisos=strstr($_SESSION['perm'], 'borrar');
...
<div id="contenido">
		...
		<p>Eliminar póliza autos</p>
        		<table width="950" align="center" border="0" cellspacing="0" cellpadding="0">
				<tr valign="top">
                    <td width="153"><div id="etiqueta">Comisión subagente:</div></td>
                    <td width="318"><input type="text" name="comsub" id="comsub" autocomplete="off" size="55" value="<?php  echo $comsubn; ?>" readonly="readonly"/></td>
                    ...
                    <td width="228"><input type="hidden" name="mundo" value="<?php  echo $idn; ?>" /></td>
                    <td width="10"></td>
            	</tr>
                <tr>
					...
					<td width="477">
						<table width="477" align="left" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td><input type="text" name="txtNombre" id="txtNombre" autocomplete="off" size="55" value="<?php  echo $contr; ?>" readonly="readonly" />
								  <div id="autonombre" class="autocomplete" style="display:none"></div></td>
								</tr>
								<tr valign="top">
									<td><div id="etiqueta"><label>Datos contratante:</label></div></td>
									<td><textarea name="datosclie" id="datosclie" readonly="readonly"><?php  echo $datosn; ?></textarea></td>
								</tr>
						</table>
					</td> 
					<td width="473">
						<table width="473" align="left" border="0" cellspacing="0" cellpadding="0">
								<tr valign="top">
									...
									<td width="372"><input type="text" size="20" name="poliza" autocomplete="off" value="<?php  echo $numpol; ?>" readonly="readonly" /></td>
								</tr>
								<tr>
			...
			<table cellpadding="0" cellspacing="0" border="1" align="center" width="387">
                ...
                <tr>
                    ...
                    <td width="280"><input type="text" size="55" id="marca" name="marca" autocomplete="off" value="<?php  echo $marcah; ?>" readonly="readonly" /><div id="automarca" class="autocomplete" style="display:none"></div></td>
                </tr>
                <tr>
                    <td><div id="etiqueta">
