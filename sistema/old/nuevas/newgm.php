...
<div id="contenido">
		<p>Nueva póliza gastos médicos</p>
			<form id="formRegistro" action="../add/addgm.php" method="post" onsubmit="return checamens(this);">
			...
			<table cellpadding="0" cellspacing="0" border="1" align="center" width="387">
                ...
                <tr>
                    ...
                    <td><input type="text" size="30" name="titular" id="titular" autocomplete="off" /></td>
                </tr>
                <tr>
                    <td><div id="etiqueta">
                      <label>Dependiente(s):</label></div></td>
                    <td><textarea name="dependientes" rows="25" cols="5"></textarea></td>
                </tr>
		   ...
		   <tr align="center">
                    <td colspan="2" align="center"><div id="btn">
                      <input type="submit" name="submit" value="Guardar póliza" />
						<input type="hidden" name="tipopol" value="gm" />
                    </div></td>
                </tr>
            </table>
