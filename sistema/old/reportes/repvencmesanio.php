...
<div id="contenido">
		<p>Reporte vencimiento de pólizas por mes y año.</p>
					...
					<td width="950">
						<table width="430" align="center" border="0" cellspacing="0" cellpadding="0">
								...
								<tr valign="top" align="center">
									<td colspan="2" align="center"><input type="button" value="Consultar" onclick="buscapol('../ajax/repvencmesanio.php','showpol','mes='+document.getElementById('mes').value+'&anio='+document.getElementById('anio').value+'&compania='+document.getElementById('compania').value+'&categoria='+document.getElementById('categoria').value,'POST');"/>
</td>
								</tr>
						</table>
					</td> 
