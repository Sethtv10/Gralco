					...
					<td width="950">
						<table width="430" align="center" border="0" cellspacing="0" cellpadding="0">
								...
								<tr valign="top" align="center">
									<td colspan="2" align="center"><input type="button" value="Consultar" onclick="buscapol('../ajax/repagente.php','showpol','mes='+document.getElementById('mes').value+'&anio='+document.getElementById('anio').value+'&compania='+document.getElementById('compania').value+'&categoria='+document.getElementById('categoria').value+'&subagente='+document.getElementById('subagente').value,'POST');"/>
</td>
								</tr>
						</table>
					</td> 
