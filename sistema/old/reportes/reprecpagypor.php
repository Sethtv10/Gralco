...
<div id="contenido">
		<p>Reporte recibos pagados  y por pagar.</p>
					...
					<td width="950">
						<table width="430" align="center" border="0" cellspacing="0" cellpadding="0">
								...
								<tr valign="top" align="center">
									<td colspan="2" align="center"><input type="button" value="Consultar" onclick="buscapol('../ajax/reprecpagos.php','showpol','mes='+document.getElementById('mes').value+'&anio='+document.getElementById('anio').value,'POST');"/>
</td>
								</tr>
						</table>
					</td> 
