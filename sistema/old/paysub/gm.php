...
<div id="contenido">
		<p>Pagar subagente póliza gastos médicos</p>
            ...
            <table width="950" align="center" border="0" cellspacing="0" cellpadding="0">
				<tr valign="top">
                    ...
                    <td width="299"><input type="text" name="comsub" id="comsub" autocomplete="off" size="55" value="<? echo $comsubn; ?>" /></td>
                    <td width="230"><select name="diasub" size="1">
									<? for ($a=1;$a<=31;$a++)
										{
									?>
                    ...
                    <td width="258"><? if ($comsubn=="") { ?><input type="submit" name="submit" value="pagar" /><? } ?></td>
                    <td width="10"></td>
            	</tr>
                <tr>
