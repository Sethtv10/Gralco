...
<div id="contenido">
		<p>Pagar subagente póliza camiones</p>
        	...
        	<table width="950" align="center" border="0" cellspacing="0" cellpadding="0">
				<tr valign="top">
                    <td width="156"><font color="#FFFFFF">Comisión subagente:</font></td>
                    <td width="307"><input type="text" name="comsub" id="comsub" autocomplete="off" size="55" value="<? echo $comsubn; ?>" /></td>
                    <td width="207"><select name="diasub" size="1">
									<? for ($a=1;$a<=31;$a++)
										{
									?>
                    ...
                    <td width="270"><? if ($comsubn=="") { ?><input type="submit" name="submit" value="pagar" /><? } ?></td>
                    <td width="10"></td>
            	</tr>
                <tr>
			...
			<table cellpadding="0" cellspacing="0" border="1" align="center" width="387">
                <tr>
                    <td height="41" colspan="2" align="center"><div id="etiqueta2" align="center">
                      <label>Datos del camión:</label></div></td>
              </tr>
                <tr>
