...
<script type="text/javascript" src="../ajax/formvida.js"></script>
...
<div id="contenido">
		<p>Nueva póliza vida</p>
			<form id="formRegistro" action="../add/addvida.php" method="post" onsubmit="return checamens(this);">
			...
			<table cellpadding="0" cellspacing="0" border="1" align="center" width="387">
                ...
                <tr>
                    ...
                    <td width="280"><input type="text" size="55" id="plan" name="plan" autocomplete="off" /><div id="autoplan" class="autocomplete" style="display:none"></div></td>
                </tr>
                <tr>
                    <td><div id="etiqueta">
                      <label>Contratante:</label></div></td>
                    <td><input type="text" size="30" name="contratante" id="contratante" autocomplete="off" /></td>
                </tr>
                <tr>
                    <td><div id="etiqueta">
                      <label>Asegurado:</label></div></td>
                    <td><input type="text" size="55" id="asegurado" name="asegurado" autocomplete="off" /></td>
                </tr>
                <tr>
                    <td><div id="etiqueta">
                      <label>Asegurado<br />
                      mancomunado:</label></div></td>
                    <td><input type="text" size="55" id="aseguradoman" name="aseguradoman" autocomplete="off" /></td>
                </tr>
                <tr>
                    <td><div id="etiqueta">
                      <label>Asegurado<br />
                      menor:</label></div></td>
                    <td><input type="text" size="55" id="aseguradomenor" name="aseguradomenor" autocomplete="off" /></td>
                </tr>
				 <tr align="center">
