...
<script type="text/javascript" src="../ajax/formcam.js"></script>
...
<div id="contenido">
		<p>Nueva póliza camiones</p>
			<form id="formRegistro" action="../add/addcamion.php" method="post" onsubmit="return checamens(this);">
						...
						<table cellpadding="0" cellspacing="0" border="0" align="center">
							<tr>
								...
								<td><select name="formapago" size="1" >
                                	<option value="0" selected="selected">Pago único</option>
			...
			<table cellpadding="0" cellspacing="0" border="1" align="center" width="387">
                ...
                <tr>
                    ...
                    <td><select name="tipocarga" size="1" >
									<option selected="selected" value="No peligrosa">No peligrosa</option>
