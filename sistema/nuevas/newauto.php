...
{
	var nombre=encodeURIComponent(document.getElementById('txtNombre').value);
	if(nombre=="")
	{
		alert("Debes de escribir el nombre del cliente");	
	}
	else
	{
		//datos('../ajax/cliente.php','datosclie','nombre='+document.getElementById('txtNombre').value,'POST');	
		datos('../ajax/cliente.php','datosclie','nombre='+nombre,'POST');
	}
}
</script>
					...
					<td width="477">
						<table width="477" align="left" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td><input type="text" name="txtNombre" id="txtNombre" autocomplete="off" size="55" /><img src="../images/lupa.jpg" width="21" height="20" onclick="checacliente()" align="top" />
