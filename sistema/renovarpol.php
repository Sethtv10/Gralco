		...
		<p>Renovar póliza</p>
						...
						<table width="430" align="center" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td>
										...
										<select id="anio" name="anio" size="1">
											<option value="<?php echo $anio-1; ?>"><?php echo $anio-1; ?></option>
											<option selected value="<?php echo $anio; ?>"><?php echo $anio; ?></option>
											<option value="<?php echo $anio+1; ?>"><?php echo $anio+1; ?></option>
										</select>
									</td>
								</tr>
            ...
            <div id="autopoliza" class="autocomplete" style="display:none"></div></td>
								...
								<tr valign="top" align="center">
									<td colspan="2" align="center"><input type="button" value="Consultar" onclick="buscapol('ajax/renuevapol.php','showpol','nombre='+document.getElementById('txtNombre').value+'&poliza='+document.getElementById('txtpoliza').value+'&anio='+document.getElementById('anio').value+'&mes='+document.getElementById('mes').value,'POST');"/>
<div id="autopoliza" class="autocomplete" style="display:none"></div></td>
								</tr>
						</table>
					</td> 
