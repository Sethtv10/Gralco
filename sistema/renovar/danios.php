		...
		<p>Renovar póliza daños</p>
					...
					<td width="477">
						<table width="477" align="left" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td><input type="text" name="txtNombre" id="txtNombre" autocomplete="off" size="55" value="<?php  echo $contratante; ?>" /><img src="../images/lupa.jpg" width="21" height="20" onclick="datos('../ajax/cliente.php','datosclie','nombre='+document.getElementById('txtNombre').value,'POST');" align="top" />
						...
						<table width="473" align="left" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<?php  for ($a=1;$a<=31;$a++)
										{
									?>
											<option <?php  if ($a==$deldia) { ?> selected="selected" <?php  } ?> value="<?php  echo $a; ?>" ><?php  echo $a; ?></option>
									<?php 
										}
									?>
									</select>
									...
									<?php  for ($a=1;$a<=12;$a++)
										{
									?>
											<option <?php  if ($a==$delmes) { ?> selected="selected" <?php  } ?> value="<?php  echo $a; ?>" ><?php  echo $a; ?></option>
									<?php 
										}
									?>
									</select>&nbsp;<input type="text" size="4" id="vigdelanio" name="vigdelanio" maxlength="4" value="<?php  echo $delanio+1; ?>" /></td>
								</tr>
								<tr>
									...
									<?php  for ($a=1;$a<=31;$a++)
										{
									?>
											<option <?php  if($a==$aldia) { ?> selected="selected" <?php  } ?> value="<?php  echo $a; ?>"><?php  echo $a; ?></option>
									<?php 
										}
									?>
									</select>
									...
									<?php  for ($a=1;$a<=12;$a++)
										{
									?>
											<option <?php  if($a==$almes) { ?> selected="selected" <?php  } ?> value="<?php  echo $a; ?>"><?php  echo $a; ?></option>
									<?php 
										}
									?>
						...
						<table cellpadding="0" cellspacing="0" border="0" align="center">
							...
							<tr>
								...
								<td><select name="moneda" size="1" >
									<option value="Nacional" <?php  if($moneda=="Nacional"){ ?>selected="selected" <?php  } ?>>Nacional</option>
									<option value="Dolares" <?php  if($moneda=="Dolares"){ ?>selected="selected" <?php  } ?>>Dolares</option>
									</select>
								</td>
							</tr>
						</table>
					...
					<td width="318">
						<table cellpadding="0" cellspacing="0" border="1" align="center">
							...
							<tr>
								...
								<td><input type="text" size="8" id="importe" name="importe" value="<?php  echo $total; ?>" /></td>
							</tr>
					  </table>
					</td>
				</tr>
            ...
            <table cellpadding="0" cellspacing="0" border="1" align="center" width="387">
              	<tr>
				    ...
				    <input type="hidden" name="tipopol" value="daños" /><input type="hidden" name="id" value="<?php  echo $_GET['id']; ?>"/></td>
              	</tr>
              	<tr>
                	<td>
                    </td>
